...
const DocumentViewerModal: React.FC<DocumentViewerModalProps> = ({
    ...
    const handleDownloadAllDocs = useCallback(async () => {
        ...
        const body = {
            document_type: "document",       // ✅ backend should support this
            categorize_by_user: false,
            categorize_by_type: false,
            request_ids: inferredRequestIds,  // ✅ NEW
            only_approved: only_approved
            // if you later want approved-only:
            // only_approved: true/false
        };

        await fetchZip(body as any, undefined, false, { responseType: "blob" });
    }, [canDownloadAll, zipLoading, inferredRequestIds, fetchZip]);
    ...
    const openDocAtIndex = useCallback(
        async (idx: number) => {
            ...
            // your backend expects { path: doc.id, responseType: "blob" }
    ...
    useEffect(() => {
        ...
        const forcedType =
            currentDocMime || rawBlob.type || "application/octet-stream";
        ...
        const isText =
            forcedType.startsWith("text/") || forcedType === "application/json";
    ...
    const download = useCallback(() => {
        ...
        // default behavior: same as open (download attribute)
        openInNewTab();

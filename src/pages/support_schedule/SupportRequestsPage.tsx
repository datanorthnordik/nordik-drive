...
export default function SupportRequestsPage() {
  ...
  return (
    <Container maxWidth="lg" sx={{ pt: { xs: 11, md: 14 }, pb: 6 }}>
      ...
      <Dialog open={showCreate} onClose={() => setShowCreate(false)} fullWidth maxWidth="xl" scroll="paper" PaperProps={{ sx: { minHeight: { lg: "min(760px, calc(100vh - 6rem))" } } }}><DialogTitle>New support request</DialogTitle><DialogContent><Box sx={{ pt: 1 }}><SupportBookingForm onRequested={() => { setShowCreate(false); reload(); }} /></Box></DialogContent></Dialog>
